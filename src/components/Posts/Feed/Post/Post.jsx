 ...
 * @param {Props} props
 */
function Post({ type, plantName, imageUrl, description, location: { latitude, longitude }, contact }) {
    ...
    if (filters.location) {
      return (
        <p className={styles['distance']}>
          {distanceFormatter.format(distanceMeters(filters.location.center, [latitude, longitude]) / 1609.344)} mi
        </p>
      );
    } else {
      return <></>;
